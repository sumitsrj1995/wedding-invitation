...
import { sampleCameraPath, useScrollProgressRef } from './scrollProgress';
...
export default function ScrollCameraRig({ reducedMotion = false }) {
  ...
  useFrame((state, delta) => {
    ...
    const sample = sampleCameraPath(dampedProgress.current, cameraKeyframes);
