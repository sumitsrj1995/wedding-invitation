import{r as o,j as r}from"./index-D9FeRegZ.js";import{V as m,a as S,N as z,A as I,B,S as T,u as C,b as W,c as V,M as U,Q as $,C as O}from"./react-three-fiber.esm-BaQviMpk.js";import{a as _,u as G,s as H,E as Q,B as K,D as q,V as Y,S as J}from"./Vignette-Drr-Ykql.js";import{S as X}from"./SpaceEnvironment-VFf3Chom.js";import"./Sparkles-GCOzvV77.js";const f=Math.PI/180;function x(){return new Date}function Z(e){return e.getTime()/864e5+24405875e-1}function ee(e){const t=Z(e)-2451545,c=(280.46+.9856474*t)%360*f,n=(357.528+.9856003*t)%360*f,s=c+(1.915*Math.sin(n)+.02*Math.sin(2*n))*f,a=(23.439-4e-7*t)*f;return Math.asin(Math.sin(a)*Math.sin(s))}function j(e=x(),i=new m){const t=ee(e),n=(12-(e.getUTCHours()+e.getUTCMinutes()/60+e.getUTCSeconds()/3600+e.getUTCMilliseconds()/36e5))*15*f,s=Math.cos(t);return i.set(s*Math.cos(n),Math.sin(t),s*Math.sin(n)).normalize()}const g="/textures/theme3/",F=Math.PI,te=.02,re=`
  varying vec2 vUv;
